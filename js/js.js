$("document").ready(function () {
  ...
  $(".kalkun").click(function () {
    $(this).css({
      background: "url(images/kalkun.png)",
    });
    $("<audio></audio>")
      .attr({
  ...
  $(".babi").click(function () {
    $(this).css({
      background: "url(images/babi.jpg)",
    });
    $("<audio></audio>")
      .attr({
        src: "audio/babi.mp3",
  ...
  $(".sapi").click(function () {
    $(this).css({
      background: "url(images/sapi.png)",
    });
    $("<audio></audio>")
      .attr({
        src: "audio/sapi.mp3",
  ...
  $(".kambing").click(function () {
    $(this).css({
      background: "url(images/kambing.png)",
    });
    $("<audio></audio>")
      .attr({
  ...
  $(".harimau").click(function () {
    $(this).css({
      background: "url(images/harimau.png)",
    });
    $("<audio></audio>")
      .attr({
  ...
  $(".singa").click(function () {
    $(this).css({
      background: "url(images/singa.png)",
    });
    $("<audio></audio>")
      .attr({
        src: "audio/singa.mp3",
  ...
  $(".komodo").click(function () {
    $(this).css({
      background: "url(images/komodo.png)",
    });
    $("<audio></audio>")
      .attr({
  ...
  $(".badak").click(function () {
    $(this).css({
      background: "url(images/badak.png)",
    });
    $("<audio></audio>")
      .attr({
        src: "audio/badak.mp3",
